...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__register__ = __webpack_require__(535);
                    ...
                    _this.authProvider.saveRegisteredUser(userId, userData_1).then(function (res) {
                        _this.authProvider.sendEmailVerification().then(function (emailRes) {
                            ...
                            var toast = _this.toastCtrl.create({
                                message: 'Email verification was sent, please verify your account to login',
                                duration: 5000,
                                position: 'bottom'
                            });
                            toast.present();
