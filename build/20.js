...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__admin_buy_and_sell__ = __webpack_require__(633);
...
var AdminBuyAndSellPageModule = (function () {
    ...
    AdminBuyAndSellPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__admin_buy_and_sell__["a" /* AdminBuyAndSellPage */]),
            ],
        })
...
var AdminBuyAndSellPage = (function () {
    function AdminBuyAndSellPage(navCtrl, navParams, authProvider, modalCtrl, alertCtrl, toastCtrl, actionSheetCtrl, loadingCtrl) {
    ...
    AdminBuyAndSellPage.prototype.onSearch = function (ev) {
        ...
        this.db.collection('buypets').orderBy("datePosted", "desc").limit(1000).onSnapshot(function (snapshots) {
    ...
    AdminBuyAndSellPage.prototype.getItems = function () {
        var _this = this;
        this.db.collection('buypets').orderBy("datePosted", "desc").onSnapshot(function (snapshots) {
            console.log('snapshots', snapshots);
            var pets = [];
            snapshots.forEach(function (doc) {
                var docData = doc.data();
    ...
    AdminBuyAndSellPage.prototype.removePost = function (buyPetId, status) {
        var _this = this;
        var title = '';
        var message = '';
        if (status == 1) {
    ...
    AdminBuyAndSellPage.prototype.action = function (petId, status) {
        var _this = this;
        var text = '';
        if (status == 1) {
            text = 'Mark as sold';
    ...
    AdminBuyAndSellPage.prototype.interestedView = function (petId) {
        var _this = this;
    ...
    AdminBuyAndSellPage.prototype.checkFocus = function () {
