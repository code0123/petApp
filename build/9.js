...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lostpets__ = __webpack_require__(643);
...
var LostpetsPage = (function () {
    ...
    LostpetsPage.prototype.onSearch = function (ev) {
        ...
        this.db.collection('lostpets').where("status", "==", false).orderBy("datePosted", "desc").limit(1000).onSnapshot(function (snapshots) {
            var pets = [];
