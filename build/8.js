...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pet__ = __webpack_require__(643);
...
var PetPageModule = (function () {
    ...
    PetPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__pet__["a" /* PetPage */]),
            ],
        })
    ], PetPageModule);
...
var PetPage = (function () {
    ...
    PetPage.prototype.removePost = function (buyPetId, status) {
        var _this = this;
        var title = '';
        var message = '';
        if (status == 1) {
    ...
    PetPage.prototype.action = function (petId, status) {
        var _this = this;
        var text = '';
        if (status == 1) {
            text = 'Mark as sold';
    ...
    PetPage.prototype.checkFocus = function () {
